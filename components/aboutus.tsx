...
const AboutUs: React.FC = () => {
  return (
    <div className="bg-black">
      ...
      <section className="text-center text-white py-12 px-4" id='about'>
        <h2 className="text-2xl font-bold">Mission And Values</h2>
        <p className="mt-4 text-whitew-2xl mx-auto">
        ...
        <div className="flex text-white justify-center space-x-8 mt-8 animate-fadeIn">
      ...
      <section className="text-center text-white py-12 px-4">
      ...
      <section className="bg-black text-white py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-5xl mx-auto">
          <div className="p-4 shadow-lg rounded-lg hover:scale-110 bg-gray-900 hover:bg-blue-600">
            ...
            <p className="text-gray-500 mt-2">Utilizing the latest frameworks and libraries like React, Next.js, and Tailwind CSS for fast, scalable applications.</p>
          </div>
          <div className="p-4 shadow-lg rounded-lg hover:scale-110 bg-gray-900 hover:bg-blue-600">
            <h3 className="text-xl font-bold">Cloud Integration</h3>
            <p className="text-gray-500 mt-2">Seamless integration with cloud platforms such as AWS and Google Cloud for scalable hosting solutions.</p>
          </div>
        </div>
      </section>
      ...
      <section className="text-center text-white py-12 px-4 w-full">
        ...
        <div className="mt-8">
          <div className="p-4 border rounded-lg shadow-md transition transform hover:scale-100 hover:bg-blue-600 scale-90">
            ...
            <p className="mt-2 text-gray-500">You can start by learning the basics of frontend technologies like HTML, CSS, and JavaScript. Build projects to improve your skills!</p>
          </div>
          <div className="p-4 border rounded-lg shadow-md transition transform hover:scale-100 hover:bg-blue-600 scale-90 mt-4">
            ...
            <p className="mt-2 text-gray-500">We use modern tools like React, Next.js, Node.js, Tailwind CSS, and more to build efficient and scalable web applications.</p>
          </div>
          <div className="p-4 border rounded-lg shadow-md transition transform hover:scale-100 hover:bg-blue-600 scale-90 mt-4">
            <h3 className="text-xl font-bold">Do you offer ongoing support after launch?</h3>
            <p className="mt-2 text-gray-500">Yes, we offer ongoing support and maintenance to ensure your application stays up-to-date and secure.</p>
          </div>
        </div>
      </section>
    </div>
